...
import { FaExternalLinkAlt, FaFacebook, FaInstagram, FaGlobe, FaEnvelope} from "react-icons/fa"; 
import { isConstructorTypeNode } from 'typescript';

const InfoPage = () => {
  let params = useParams();
  const [club, setClub] = useState({name: '', category: '', email: '', description: '', socials: '', events: []}); // useState hook stores club object from API calll in the club state
        ...
        <div className="infoContainer">
          <div className="statusContainer">
            <div className="statusContents">
              Recruitment has closed. Check back later for recruitment times next semester!
            </div>
          </div>
